...
After you have setup the motors in their correct places, and plugged them into the correct ports, (cm1 goes to port 0, cm2 goes to port 1, and so on), you must define the motor locations in the app.&#x20;

### Running the Code

Once that is done, run the following code under a TeleOp mission named `"MecanumDrivetrain"`.
